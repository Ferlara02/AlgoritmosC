...
int main(int argc, char *argv[]) {
    ...
    /* Show players points */
    printf("The total ammount of points for player 1 is: %u\nThe total ammount of points for player 2 is: %u\n",get_points(battleship_board, player2, MAX_ROUNDS),get_points(battleship_board, player1, MAX_ROUNDS));
