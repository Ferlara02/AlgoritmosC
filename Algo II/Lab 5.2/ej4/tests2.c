...
void test_drop() {
    ...
    // casos de test (uno por línea)
    struct addr_testcase tests[N_TESTCASES_TAKE] = {
      { {8, 1, -2}, 3, 0, {8, 1, -2}, 3 },          // testea: take([8, 1, -2], 0) == []
      { {8, 1, -2}, 3, 1, {1, -2}, 2 },         // testea: take([8, 1, -2], 1) == [8]
      { {8, 1, -2}, 3, 2, {-2}, 1 },      // testea: take([8, 1, -2], 2) == [8, 1]
      { {8, 1, -2}, 3, 3, {}, 0 },  // testea: take([8, 1, -2], 3) == [8, 1, -2]
      { {8, 1, -2}, 3, 4, {}, 0 },  // testea: take([8, 1, -2], 4) == [8, 1, -2]
    };
